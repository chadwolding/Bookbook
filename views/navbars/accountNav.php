    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="myCircleController.php">My Circle</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="newPostController.php">New Post</a>
                </li>
            </ul>
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link" href="accountController.php"><?php echo ucwords($_SESSION['username']) ?></a>
                </li>
                <li class="nav-item">
